...
<div class="container">
    ...
    <form name="loginForm" id="register-form" method="post" action="EmployeeServlet">
        ...
        <table>
            ...
            <tr>
                <th>essn:</th>
                <td><input type="text" name="essn" id="newessn" value="<%=essn%>" readonly="true"></td>
            </tr>
            <tr>
                <th>address:</th>
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" id="submit-form" onclick="ajaxData()">Submit</button>
                </td>
            </tr>
        </table>
    </form>
